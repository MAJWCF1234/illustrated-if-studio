...
IF THE STUDIO WON'T OPEN
------------------------

1. Double-click:  SETUP-ADMIN.bat
2. Windows will ask "Do you want to allow this app to make changes?" - click YES.
   (This is Windows finishing a one-time install. It needs the internet.)
3. Let it run until it says it's done, then close that window.
4. Go back to the main folder and double-click "Illustrated IF Studio" again.
...
STILL STUCK?
------------
Send whoever gave you this folder a photo of whatever error you see. The manual
RUN-EDITOR.bat window above is the best thing to screenshot.
