/** Canonical default game UX — void-violet black/purple + illustrated-if scene/menu. */
...
export function mergeTheme(partial) {
  ...
  return {
    ...
    audio: {
      ...
      ...(partial.audio || {}),
      channels: {
        bgm: { ...base.audio.channels.bgm, ...(partial.audio?.channels?.bgm || {}) },
        sfx: { ...base.audio.channels.sfx, ...(partial.audio?.channels?.sfx || {}) },
      },
    },
    templates: {
